...
/**
 * `HttpURLConnection` that forwards everything to the real connection while a
 * [UrlConnectionRecorder] watches the request and response streams.
 */
internal class MonitoredHttpURLConnection(
